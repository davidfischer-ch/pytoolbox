...
#sys.path.insert(0, os.path.abspath('../../pytoolbox'))
...
latex_documents = [
  ('index', 'pytoolbox.tex', 'pytoolbox Documentation',
...
man_pages = [
    ('index', 'pytoolbox', 'pytoolbox Documentation',
     ['David Fischer'], 1)
]
...
texinfo_documents = [
  ('index', 'pytoolbox', 'pytoolbox Documentation',
   'David Fischer', 'pytoolbox', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_copyright = '2013, David Fischer'
