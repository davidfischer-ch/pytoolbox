...
class TestKill:
    """Tests for the kill() helper."""

    def test_kill_ignores_esrch(self) -> None:
    ...
    def test_kill_reraises_other_oserror(self) -> None:
    ...
    def test_kill_ignores_nosuchprocess(self) -> None:
    ...
    def test_kill_reraises_generic_exception(self) -> None:
...
class TestSu:
    ...
    def test_su_with_string_names(self) -> None:
...
class TestMakeAsync:
    ...
    def test_make_async_with_fd_object(self) -> None:
    ...
    def test_make_async_with_raw_int(self) -> None:
...
class TestReadAsync:
    ...
    def test_read_async_reraises_other_ioerror(self) -> None:
...
class TestCmdAdvanced:
    """Tests for cmd() edge cases not covered by existing tests."""

    def test_cmd_with_user_prepends_sudo(self, caplog) -> None:
    ...
    def test_cmd_with_input(self) -> None:
    ...
    def test_cmd_communicate_false(self) -> None:
    ...
    def test_cmd_cli_input(self) -> None:
    ...
    def test_cmd_custom_success_codes(self) -> None:
    ...
    def test_cmd_timeout_kills_process(self) -> None:
...
class TestRawCmd:
    ...
    def test_raw_cmd_returns_process(self) -> None:
    ...
    def test_raw_cmd_shell_mode(self) -> None:
...
class TestMake:
    """Tests for make() build helper."""

    def test_make_without_cmake(self) -> None:
    ...
    def test_make_no_install(self) -> None:
    ...
    def test_make_keep_temporary(self) -> None:
...
class TestRsync:
    ...
    def test_rsync_basic(self) -> None:
    ...
    def test_rsync_with_options(self) -> None:
    ...
    def test_rsync_dir_appends_separator(self) -> None:
