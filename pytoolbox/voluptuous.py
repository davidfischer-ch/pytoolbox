...
def Email(value: str) -> str:  # pylint:disable=invalid-name
...
def EmailSet(values: list[str] | None) -> set[str]:  # pylint:disable=invalid-name
...
def GitCommitHash(value: str) -> str:  # pylint:disable=invalid-name
...
def Password(length: int = 16, msg: str | None = None) -> Callable:  # pylint:disable=invalid-name
...
def Percent(value: int) -> int:  # pylint:disable=invalid-name
...
def SHA256(value: str) -> str:  # pylint:disable=invalid-name
...
def Version(digits: int = 4, msg: str | None = None) -> Callable:  # pylint:disable=invalid-name
